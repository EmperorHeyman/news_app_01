...
/* harmony import */ var _news_card_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./news-card.component.html?ngResource */ 4818);
/* harmony import */ var _news_card_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./news-card.component.scss?ngResource */ 1556);
...
/* harmony import */ var src_app_storage_useStorage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/storage/useStorage */ 9962);
...
let NewsCardComponent = class NewsCardComponent {
    constructor(toastController, indexStorage, activatedRoute) {
    ...
    ngOnInit() { }
    removed_clicked(event) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            let article_saved = false;
            const store = new _ionic_storage__WEBPACK_IMPORTED_MODULE_2__.Storage();
            store.create();
            const keys = yield store.keys();
            console.log(this.news.title);
            for (let key of keys) {
                const storedArticle = yield store.get(key);
...
NewsCardComponent.ctorParameters = () => [
    ...
    { type: src_app_storage_useStorage__WEBPACK_IMPORTED_MODULE_3__.IndexStorageService },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__.ActivatedRoute }
];
NewsCardComponent.propDecorators = {
    news: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_7__.Input }]
};
NewsCardComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
/***/ 3372:
/*!**********************************************************!*\
  !*** ./src/app/components/news-card/news-card.module.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "NewsCardComponentModule": () => (/* binding */ NewsCardComponentModule)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ 6362);
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ 3819);
/* harmony import */ var _news_card_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./news-card.component */ 2624);





let NewsCardComponentModule = class NewsCardComponentModule {
};
NewsCardComponentModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        ...
        declarations: [_news_card_component__WEBPACK_IMPORTED_MODULE_0__.NewsCardComponent],
        exports: [_news_card_component__WEBPACK_IMPORTED_MODULE_0__.NewsCardComponent],
    })
...
/* harmony import */ var _components_news_card_news_card_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/news-card/news-card.module */ 3372);
...
FolderPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [
            ...
            _components_news_card_news_card_module__WEBPACK_IMPORTED_MODULE_2__.NewsCardComponentModule,
        ],
...
let FolderPage = class FolderPage {
    ...
    ngOnInit() {
        ...
        if (this.folder == "saved") {
            const store = new _ionic_storage__WEBPACK_IMPORTED_MODULE_3__.Storage();
            store.create();
    ...
    getTopHeadlines(i) {
        this.newsApiService
            ...
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)((res) => res.articles))
            .subscribe((news) => {
...
let NewsapiService = class NewsapiService {
    ...
    getTopCountryHeadlines(country, category, pages) {
        return this.http.get(`https://newsapi.org/v2/top-headlines/?country=${country}&category=${category}&pageSize=10&apiKey=76be927b28d14be6ad1ebd82981a685f&page=${pages}`);
    }
};
NewsapiService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpClient }
];
NewsapiService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "IndexStorageService": () => (/* binding */ IndexStorageService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 3184);


let IndexStorageService = class IndexStorageService {
    constructor() {
        this.index_storage = 0;
    }
};
IndexStorageService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
/* harmony export */ });
/* harmony import */ var I_IONIC_fai_ap5pm_pon_15_17_Emperors_news_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
class Storage {
  ...
  create() {
    ...
    return (0,I_IONIC_fai_ap5pm_pon_15_17_Emperors_news_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
/***/ 1556:
/*!**************************************************************************!*\
  !*** ./src/app/components/news-card/news-card.component.scss?ngResource ***!
  \**************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = "#news_card_style {\n  margin-top: 0;\n}\n\n#save_button {\n  margin-top: 10px;\n  margin-left: 2%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
/***/ 4818:
/*!**************************************************************************!*\
  !*** ./src/app/components/news-card/news-card.component.html?ngResource ***!
  \**************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = "<div *ngIf=\"id=='saved'\">\n    <ion-button value=\"news.url\" (click)=\"removed_clicked($event)\" id=\"remove_button\" color=\"light\">odebrat</ion-button>\n</div>\n<div *ngIf=\"id!='saved'\">\n    <ion-button value=\"news.url\" (click)=\"saved_clicked($event)\" id=\"save_button\" color=\"light\">uložit</ion-button>\n</div>\n\n\n\n<ion-card id=\"news_card_style\" href=\"{{ news.url }}\" target=\"_blank\" rel=\"noopener noreferrer\">\n\n    <ion-img *ngIf=\"news.urlToImage\" src=\"{{ news.urlToImage }}\"></ion-img>\n    <ion-card-header>\n        <ion-card-subtitle>{{ news?.source?.name }}</ion-card-subtitle>\n        <ion-card-title> {{ news.title }}</ion-card-title>\n    </ion-card-header>\n\n    <ion-card-content>\n        {{ news.description }}\n    </ion-card-content>\n</ion-card>";
